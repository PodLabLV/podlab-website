    ...
    <HomePageWrapper>
      <div className="min-h-screen">
        ...
        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              {values.map((value) => (
                <div key={value.title} className="glass-card p-8 group hover:border-accent hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(42,221,27,0.15)] transition-all duration-350 cursor-pointer">
        ...
        <section className="relative py-24 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-[0_0_80px_rgba(42,221,27,0.5)]">
              <iframe
                src="https://www.youtube.com/embed/5wqcVnpzknQ?autoplay=0&mute=0&loop=0&controls=1&modestbranding=1&playsinline=1&enablejsapi=1"
