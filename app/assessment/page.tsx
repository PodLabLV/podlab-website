      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-screen flex items-center justify-center px-6 py-12">
          <div className="max-w-4xl mx-auto w-full">
            ...
            {/* Video Embed */}
            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-[0_0_60px_rgba(42,221,27,0.3)] mb-8">
              <iframe
            ...
            <div className="text-center mb-6">
              <Link
                ...
                className="inline-block px-8 py-4 md:px-16 md:py-6 bg-accent text-black text-xl font-black rounded-xl hover:bg-accent-hover transition-all hover:-translate-y-2 hover:scale-105 hover:shadow-[0_20px_60px_rgba(42,221,27,0.6)] active:scale-95 uppercase tracking-wider"
              >
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 group">
        ...
        <section className="py-24 px-6">
          <div className="glass-card max-w-3xl mx-auto text-center p-8 md:p-12">
            ...
            <Link
              href="/assessment/start"
              className="inline-block px-10 py-5 md:px-20 md:py-8 bg-accent text-black text-xl md:text-2xl font-black rounded-xl hover:bg-accent-hover transition-all hover:-translate-y-2 hover:scale-105 hover:shadow-[0_20px_60px_rgba(42,221,27,0.6)] active:scale-95 uppercase tracking-wider mb-8"
            >
              Take the Free Assessment →
            </Link>
