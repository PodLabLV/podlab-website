      ...
      <div className="max-w-7xl mx-auto">
        <FadeIn>
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-center mb-4">
            What <span className="text-accent drop-shadow-[0_0_25px_rgba(42,221,27,0.5)]">Founders Say</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <FadeIn key={index} delay={index * 0.15} direction="up">
              <div className="bg-gradient-to-br from-bg-tertiary to-bg-secondary border-2 border-border rounded-2xl p-8 hover:border-accent hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(42,221,27,0.2)] transition-all duration-350">
                <div className="mb-6">
